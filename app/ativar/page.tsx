      ...
      <main className="auth-page-shell">
        <div className="auth-page-card">
          ...
          <p className="auth-page-card__lead">
            Este link de ativacao e invalido ou ja foi utilizado.
          </p>
    ...
    return (
      <main className="auth-page-shell">
        <div className="auth-page-card">
          ...
          <p className="auth-page-card__lead">
            Sua senha foi criada com sucesso. Voce ja pode entrar no sistema.
          </p>
          <Link href="/login" className="dashboard-button" style={{ marginTop: 8 }}>
            Entrar no painel
          </Link>
  ...
  return (
    <main className="auth-page-shell">
      <div className="auth-page-card">
        ...
        <h1>Ativar conta</h1>
        <p className="auth-page-card__lead">
          Crie uma senha para acessar o Zap Faturamento.
        </p>
